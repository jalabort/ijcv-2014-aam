...
class AAMInterface(object):
    ...
    @abc.abstractmethod
    def algorithm_result(self, image, shape_parameters, **kwargs):
        pass
...
class PartsAAMInterface(AAMInterface):
    ...
    def algorithm_result(self, image, shape_parameters,
                         appearance_parameters=None, gt_shape=None):
        return PartsAAMAlgorithmResult(
            image, self.algorithm, shape_parameters,
            appearance_parameters=appearance_parameters, gt_shape=gt_shape)
...
# Concrete Implementations of Project-Out AAM Algorithm -----------------------
...
class PIC_SD(ProjectOut):
    ...
    def run(self, image, initial_shape, gt_shape=None, max_iters=20, **kwargs):
        ...
        return self.interface.algorithm_result(
            image, shape_parameters, gt_shape=gt_shape)
...
# Abstract Interface for Fast Simultaneous AAM algorithms ---------------------
...
# Concrete Implementations of Alternating AAM Algorithm -----------------------
...
# Abstract Interface for Bayesian AAM algorithms ------------------------------
...
# Concrete Implementations of Bayesian AAM Algorithm --------------------------
